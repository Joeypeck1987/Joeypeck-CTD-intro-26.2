...
const integer = 5;
const negative = -16;
const notANumber = 4 * NaN;
const bigNumber = 16151141312111009;
...
console.log("Q3: The variable I made true is: " + turnLeft);
//The output of the above should be true.
console.log("Q3: The variable I made false is: " + turnRight);
...
console.log("Q4: Hello! My name is " + firstName + " " + lastName + " and I was born in " + country);
console.log(`Q4: Hello! My name is ${firstName} ${lastName} and I was born in the ${country}`);
...
// PUT YOUR CODE HERE
let newFloat = floatingPoint + integer;
let newInt = integer + negative;
// Don't forget your console.logs!
console.log(`Q5: This is my new floating point number: ${newFloat}`);
console.log(`Q5: This is my new integer: ${newInt}`);
// ---------- QUESTION 6 ----------
// String Methods
...
let answer7;
if (integer > 10) {
    console.log(answer7 = "Q7: " + true + ", greater than.");
} else if (integer == 10) {
    console.log(answer7 = "Q7: " + true + ", yet equal to.");
} else {
    console.log(answer7 = "Q7: " + false + ", sorry, less than.");
}
// Don't forget your console.logs!
...
if (age <= 30) {
    ...
    console.log(`Q8: ${firstName}, you can hide behind "you're young at heart," but you need to do better in life.`)
} else {
    console.log('Q8: Not a Number!')
}
// Don't forget your console.logs!
...
switch (randomNum) {
    case 1: console.log("Q9: It is certain.");
        break;
    case 2: console.log("Q9: Perhaps.");
        break;
    case 3: console.log("Q9: Absolutely not.");
        break;
    default:
        console.log("Q9: error");
        break;
}
// Don't forget your console.logs!
...
// PUT YOUR CODE HERE
const exampleNum = 31.5432;

function roundDecimals(exampleNum, decimals) {
    const factor = 10 ** decimals;
    return "Q10: " + Math.round(exampleNum * factor) / factor;
}

console.log(roundDecimals(exampleNum, 2));
// Don't forget your console.logs!
...
//PUT YOUR CODE HERE
function useParams(greet) {
    return "Q14: " + greet.toUpperCase();
}
...
const word1 = "marcescent";
const word2 = "mansuetude";
